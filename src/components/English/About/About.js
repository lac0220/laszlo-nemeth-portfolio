    ...
    return (
        <section>
            ...
            <div className="about">
                ...
                <p>After all, I started my first<span style={{fontWeight: "bold", color: "#FF6661"}}> internship as a Junior Front-End Developer</span> in May <span style={{fontFamily: '"Times New Roman", Times, serif'}} >2022</span> to gain experience in supporting software development. The project was to build and host internal order processing software on the Google Cloud Platform for a digital marketing company. I <span style={{fontWeight: "bold", color: "#FF6661"}}>created and maintained front-end code in React.js</span> (TypeScript) while collaborating with developer colleagues via GitLab and Asana. My job was, among others, <span style={{fontWeight: "bold", color: "#FF6661"}}>optimising the user interface design</span> and customising user-facing components to meet operational needs.</p> 
                <p>I am <span style={{fontWeight: "bold", color: "#FF6661"}}>currently working as a User Acceptance Testing Specialist,</span> analysing and testing specific user stories in ECMS collateral management services. I plan and execute test scenarios <span style={{fontWeight: "bold", color: "#FF6661"}}>inside a BAT environment with an agile methodology approach.</span> Nevertheless, I simulate the client behaviour by sending different SWIFT messages in XML format to the software and document test results, proving that system changes and improvements are accordingly delivered.</p>
                <p><span style={{fontWeight: "bold"}}><u>To expand the scope of my coding skills, I am always open to discussing and joining challenging front-end projects</u></span></p>
                <ul> 
                    <li>
