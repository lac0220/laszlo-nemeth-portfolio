        ...
        <section>
            ...
            <div className="about">
                ...
                <div className="about__text">
                    ...
                    <p>Seeking to broaden my expertise, I transitioned into the financial services sector as a <span style={{fontWeight: "bold", color: "#FF6661"}}> User Acceptance Testing Specialist</span>. In this role, I analyzed user stories to ensure alignment with business needs in collateral operations and <span style={{fontWeight: "bold", color: "#FF6661"}}>executed test cases</span> within a UAT environment <span style={{fontWeight: "bold", color: "#FF6661"}}>using agile methodologies</span>. I also simulated user behavior by <span style={{fontWeight: "bold", color: "#FF6661"}}>sending SWIFT messages</span> and validated back-end processes using SQL.</p>
                    <p>Most recently, I joined the Product Management team in the <span style={{fontWeight: "bold", color: "#FF6661"}}>API & Pre-Issuance Eurobonds</span> department as a <span style={{fontWeight: "bold", color: "#FF6661"}}>Product Manager</span>, driving the  D<span style={{fontFamily: '"Times New Roman", Times, serif'}}>7</span> strategy by enhancing the  D<span style={{fontFamily: '"Times New Roman", Times, serif'}}>7</span> Navigator site and data model with optimized UX features. I also define product roadmaps and design robust <span style={{fontWeight: "bold", color: "#FF6661"}}>API structures using Swagger</span>.</p>
