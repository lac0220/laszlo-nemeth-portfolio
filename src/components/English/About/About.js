    ...
    return (
        <section>
            ...
            <div className="about">
                ...
                <p>Next, I have decided to expand my skills of testing in financial services and started to work as a<span style={{fontWeight: "bold", color: "#FF6661"}}> User Acceptance Testing Specialist,</span> analysing and testing specific user stories in ECMS collateral management services. I executed test cases inside a UAT environment with an <span style={{fontWeight: "bold", color: "#FF6661"}}> agile testing methodology approach </span>and documented test results. Nevertheless, I simulated the user behaviour by sending <span style={{fontWeight: "bold", color: "#FF6661"}}>SWIFT messages</span> and monitored them with <span style={{fontWeight: "bold", color: "#FF6661"}}>SQL in databases.</span></p>
                <p>I am currently working as a<span style={{fontWeight: "bold", color: "#FF6661"}}> Product Manager in the API & Pre-Issuance Eurobonds</span> department to improve digital securities issuance services.</p>
